				...
				<div>
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<p class="text-right"><?php if($this->tpl_var['order']['orderstatus'] == 1){ ?><a class="btn btn-danger"  href="javascript:alert('~=~傻瓜 我们是学生，自己人~=~')" ?>去支付</a><?php } else { ?> <a class="btn"><?php echo $this->tpl_var['orderstatus'][$this->tpl_var['order']['orderstatus']]; ?></a><?php } ?></p>
						</div>
					</div>
				</div>
			</div>
